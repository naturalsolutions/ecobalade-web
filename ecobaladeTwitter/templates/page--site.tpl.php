...
<div class="container">
  ...
  <header role="banner" id="page-header">
    ...
    <?php print render($page['header']); ?>
	 ...
	 <?php if ($breadcrumb): /*print $breadcrumb;*/echo "<div class='breadcrumb'><a href='".$base_url."'><img src=\"../../sites/all/themes/ecobaladetwitter/img/pictos/icone_home.svg\"></a>&nbsp»&nbsp<a href='".$base_url."/les-sites' title='les sites'>Les sites</a>&nbsp»&nbsp".$title." </div>"; endif;?>
      <a id="main-content"></a>
